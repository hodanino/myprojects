            ...
            switch (opCode) {
                ...
                case 2:// write request: Upload File from current working directory to the server. -
                    ...
                    if (Files.exists(Paths.get(filesDirectory.toString(), fileNameWRQ))) {
                        ...
                        try {
                            path = Files.createFile(FileSystems.getDefault().getPath(filesDirectory.resolve(fileNameWRQ).toString()));
                            // sending ACK
                ...
                case 3:// DATA
                    ...
                    if (packetSize < 512) {
                        ...
                        comp[0] = 0; comp[1] = 5; comp[2] = 0; comp[3] = 0;
                ...
                case 4:// ACK -
                    ...
                    if (!data.isEmpty()) {
                        ...
                        dataOut[0] = (byte) 0; dataOut[1] = (byte) 3;
                        dataOut[4] = message[2]; dataOut[5] = message[3];
